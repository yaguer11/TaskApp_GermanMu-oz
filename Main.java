...
class Main {
  public static void main(String[] args) {
    ...
    int option = 0, totalTask = 1, idNumber = 1, select;
      ...
      switch (option) {
        case 1:
          ...
          if (totalTask < 4)
          {
            ...
            System.out.println("El nombre de la tarea debe contener solo letras y espacios, con una longitud máxima de 50 caracteres.");
            name = "";
              }
            }
            ...
            if ( totalTask == 1)
            {
              taskOne = new Task(name, description, date, idNumber++);
            ...
            {
              taskTwo = new Task(name, description, date,idNumber++);
              System.out.println("¡Tarea creada exitosamente!");
              System.out.println("Presione enter para continuar...");
              scanner.nextLine();
              totalTask++;
            ...
            {
              taskThree = new Task(name, description, date, idNumber++);
              System.out.println("¡Tarea creada exitosamente!");
              System.out.println("Presione enter para continuar...");
              scanner.nextLine();
              totalTask++;
